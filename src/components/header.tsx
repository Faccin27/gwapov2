          ...
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden lg:flex items-center space-x-2">
              ...
              <div className="relative">
                ...
                >
                  Portfolio
                  <ChevronDown className={`ml-1 h-3 w-3 transition-transform duration-200 ${isMegaMenuOpen ? 'rotate-180' : ''}`} />
                </button>
          ...
          <div className="lg:hidden fixed inset-0 z-[103] bg-black/90 backdrop-blur-lg h-screen">
            <div className="flex flex-col h-screen">
              ...
              <div className="p-4 flex space-x-3">
                <Button 
                  variant="outline"
                  className="flex-1 border-rose-500 text-rose-500 hover:bg-rose-500 hover:text-white py-3"
                  onClick={() => setIsOpen(false)}
                >
                  Ver Portfolio
                </Button>
