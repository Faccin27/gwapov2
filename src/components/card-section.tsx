  ...
  Todas as funções que você precisa, em um só lugar
        ...
        <div className="hidden justify-between gap-8 lg:flex">
            ...
            <div className="flex h-full w-full justify-between gap-2">
              ...
              >
                <span className="text-[#f4f4f4] flex items-center justify-center gap-1 font-medium">
                  <img src="/auth.png" alt="a" className="w-8 h-8" />
                  <h3 className="text-label text-[#f4f4f4]">
                    Auth
                  </h3>
                </span>
              </a>
              ...
              >
                <span className="text-[#f4f4f4] flex items-center justify-center gap-1 font-medium">
                  <img src="/databases.png" alt="a" className="w-8 h-8" />
                  <h3 className="text-label text-[#f4f4f4]">
                    Databases
                  </h3>
                </span>
              ...
              >
                <span className="text-[#f4f4f4] flex items-center justify-center gap-1 font-medium">
                  <img src="/storage.png" alt="a" className="w-8 h-8" />
                  <h3 className="text-label text-[#f4f4f4]">
                    Storage
                  </h3>
                </span>
              ...
              >
                <span className="text-[#f4f4f4] flex items-center justify-center gap-1 font-medium">
                  <img src="/functions.png" alt="a" className="w-8 h-8" />
                  <h3 className="text-label text-[#f4f4f4]">
                    Functions
                  </h3>
                </span>
              ...
              >
                <span className="text-[#f4f4f4] flex items-center justify-center gap-1 font-medium">
                  <img src="/realtime.png" alt="a" className="w-8 h-8" />
                  <h3 className="text-label text-[#f4f4f4]">
                    Realtime
                  </h3>
                </span>
              ...
              >
                <span className="text-[#f4f4f4] flex items-center justify-center gap-1 font-medium">
                  <img src="/messaging.png" alt="a" className="w-8 h-8" />
                  <h3 className="text-label text-[#f4f4f4]">
                    Messaging
                  </h3>
                </span>
          ...
          <div className="bg-zinc-800 text-[#f4f4f4] relative flex h-12 items-center gap-4 rounded-full border border-[#ffffff0f] border-dashed p-1 text-sm">
            ...
            >
              <span className="text-[#f4f4f4] flex items-center justify-center gap-1 font-medium">
                <img src="/sites.png" alt="a" className="w-8 h-8" />
                <h3 className="text-xs text-[#f4f4f4]">
                  Sites
                </h3>
              </span>
            </a>
