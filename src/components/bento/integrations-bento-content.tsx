...
const allIntegrationLogos: IntegrationLogo[] = [
  ...
  { src: "/icons/facebook-alt.png", alt: "Facebook", type: "image" },
  { src: "/icons/gmail.png", alt: "Gmail", type: "image" },
  { src: "/icons/google-maps.png", alt: "Google Maps", type: "image" },
  { src: "/icons/google-pay.png", alt: "Google Pay", type: "image" },
  { src: "/icons/instagram.png", alt: "Instagram", type: "image" },
  { src: "/icons/linkedin-alt.png", alt: "Linkedin", type: "image" },
  { src: "/icons/mastercard.png", alt: "Mastercard", type: "image" },
  { src: "/icons/shopify.png", alt: "Shopify", type: "image" },
  { src: "/icons/whatsapp.png", alt: "Whatsapp", type: "image" },
  { src: "/icons/youtube.png", alt: "Youtube", type: "image" },
  { src: "/icons/docker.png", alt: "Docker", type: "image" },
  { src: "/icons/linux-tux.png", alt: "Linux", type: "image" },
  { src: "/icons/google-calendar.png", alt: "Google Calendar", type: "image" },
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full p-4" style={themeVars}>
      ...
      >
        ...
        <div
          style={{
            width: "calc(100% + 40px)", // Make it slightly wider to ensure cut-off boxes
            height: "calc(100% + 40px)", // Make it slightly taller
            position: "absolute",
            top: "50%",
            left: "50%",
            ...
            gridTemplateColumns: `repeat(${GRID_COLS}, 1fr)`, // Define columns
            gridTemplateRows: `repeat(${GRID_ROWS}, 1fr)`, // Define rows
            gap: "16px", // Increased gap
            justifyItems: "center", // Center items in their cells
            alignItems: "center", // Center items in their cells
          }}
        >
          {gridState.map((box) => (
            <LogoBox
              key={box.id}
              logo={box.logo}
              isInitiallyFilled={box.isInitiallyFilled}
              isHoveredCard={isHovered}
              isFadingOut={isFadingOutLogos && !box.isInitiallyFilled} // Only fade out dynamic logos
            />
          ))}
        </div>
      </div>
