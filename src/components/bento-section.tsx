...
export function BentoSection() {
	const cards = [
		...
		},
		{
			title: "Storage",
			description:
				"Armazene e gerencie seus arquivos de forma segura e escalável.",
		...
		},
		{
			...
			description:
				"Conecte-se facilmente com pessoas ou com nossa IA nos chats.",
			...
			<div className="w-full relative flex flex-col justify-start items-start gap-6">
				<div className="self-stretch flex flex-col gap-6 z-10">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						...
						<BentoCard {...cards[3]} />
						<BentoCard {...cards[4]} />{" "}
						{/* This is the new Integrations card */}
					</div>
				</div>
			</div>
		</section>
